...
class BreadthFirstSearchPlanner:
    def __init__(self, ox, oy, reso, rr, model = '4n'):
    ...
    ## 8 direction motion model, including diagonal  
    @staticmethod
...
def main():
    ...
    # get start and goal position from config file
